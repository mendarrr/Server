...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        meals = [
            ...
            Meal(name="Pad Thai", description="Thai noodles with shrimp and peanuts", price=13.99, admin_id=3, category_id=3, image='hhttps://i.pinimg.com/236x/6a/07/1a/6a071ab6a628d73eb3fb4d3db83be920.jpg'),
            ...
            # Salads
            Meal(name="Caesar Salad", description="Romaine lettuce with Caesar dressing", price=7.99, admin_id=1, category_id=4, image='https://example.com/images/caesar_salad.jpg'),
            Meal(name="Greek Salad", description="Salad with feta cheese and olives", price=8.99, admin_id=2, category_id=4, image='https://example.com/images/greek_salad.jpg'),
            Meal(name="Caprese Salad", description="Tomatoes, mozzarella, and basil", price=9.99, admin_id=3, category_id=4, image='https://example.com/images/caprese_salad.jpg'),
            Meal(name="Cobb Salad", description="Salad with chicken, bacon, and eggs", price=10.99, admin_id=4, category_id=4, image='https://example.com/images/cobb_salad.jpg'),
            Meal(name="Garden Salad", description="Mixed greens with vegetables", price=6.99, admin_id=5, category_id=4, image='https://example.com/images/garden_salad.jpg'),
            Meal(name="Spinach Salad", description="Spinach with strawberries and nuts", price=8.99, admin_id=1, category_id=4, image='https://example.com/images/spinach_salad.jpg'),
            Meal(name="Kale Salad", description="Kale with cranberries and almonds", price=8.99, admin_id=2, category_id=4, image='https://example.com/images/kale_salad.jpg'),
            Meal(name="Quinoa Salad", description="Quinoa with vegetables and feta", price=9.99, admin_id=3, category_id=4, image='https://example.com/images/quinoa_salad.jpg'),
            Meal(name="Taco Salad", description="Salad with taco ingredients", price=10.99, admin_id=4, category_id=4, image='https://example.com/images/taco_salad.jpg'),
            Meal(name="Pasta Salad", description="Cold pasta with vegetables", price=7.99, admin_id=5, category_id=4, image='https://example.com/images/pasta_salad.jpg'),
            Meal(name="Chicken Salad", description="Salad with chicken and mayonnaise", price=9.99, admin_id=1, category_id=4, image='https://example.com/images/chicken_salad.jpg'),
            Meal(name="Broccoli Salad", description="Salad with broccoli and bacon", price=8.99, admin_id=2, category_id=4, image='https://example.com/images/broccoli_salad.jpg'),
            Meal(name="Fruit Salad", description="Mixed fresh fruits", price=7.99, admin_id=3, category_id=4, image='https://example.com/images/fruit_salad.jpg'),
            Meal(name="Beet Salad", description="Salad with beets and goat cheese", price=8.99, admin_id=4, category_id=4, image='https://example.com/images/beet_salad.jpg'),
            Meal(name="Asian Salad", description="Salad with Asian-style dressing", price=9.99, admin_id=5, category_id=4, image='https://example.com/images/asian_salad.jpg'),
            Meal(name="Avocado Salad", description="Salad with avocado and greens", price=10.99, admin_id=1, category_id=4, image='https://example.com/images/avocado_salad.jpg'),
            Meal(name="Nicoise Salad", description="Salad with tuna, eggs, and olives", price=11.99, admin_id=2, category_id=4, image='https://example.com/images/nicoise_salad.jpg'),
            Meal(name="Lentil Salad", description="Salad with lentils and vegetables", price=8.99, admin_id=3, category_id=4, image='https://example.com/images/lentil_salad.jpg'),
            Meal(name="Southwest Salad", description="Salad with corn, beans, and avocado", price=9.99, admin_id=4, category_id=4, image='https://example.com/images/southwest_salad.jpg'),
            Meal(name="Cauliflower Salad", description="Salad with roasted cauliflower", price=8.99, admin_id=5, category_id=4, image='https://example.com/images/cauliflower_salad.jpg'),

            # Desserts
            Meal(name="Chocolate Cake", description="Rich chocolate cake with frosting", price=6.99, admin_id=1, category_id=5, image='https://example.com/images/chocolate_cake.jpg'),
            Meal(name="Cheesecake", description="Creamy cheesecake with a graham crust", price=7.99, admin_id=2, category_id=5, image='https://example.com/images/cheesecake.jpg'),
            Meal(name="Tiramisu", description="Classic Italian dessert with coffee", price=8.99, admin_id=3, category_id=5, image='https://example.com/images/tiramisu.jpg'),
            Meal(name="Apple Pie", description="Apple pie with a flaky crust", price=5.99, admin_id=4, category_id=5, image='https://example.com/images/apple_pie.jpg'),
            Meal(name="Ice Cream Sundae", description="Ice cream with toppings", price=4.99, admin_id=5, category_id=5, image='https://example.com/images/ice_cream_sundae.jpg'),
            Meal(name="Brownie", description="Chocolate brownie with nuts", price=3.99, admin_id=1, category_id=5, image='https://example.com/images/brownie.jpg'),
            Meal(name="Fruit Tart", description="Tart with fresh fruits", price=6.99, admin_id=2, category_id=5, image='https://example.com/images/fruit_tart.jpg'),
            Meal(name="Panna Cotta", description="Italian dessert with cream and berries", price=7.99, admin_id=3, category_id=5, image='https://example.com/images/panna_cotta.jpg'),
            Meal(name="Creme Brulee", description="Custard with a caramelized top", price=8.99, admin_id=4, category_id=5, image='https://example.com/images/creme_brulee.jpg'),
            Meal(name="Lemon Meringue Pie", description="Pie with lemon filling and meringue", price=5.99, admin_id=5, category_id=5, image='https://example.com/images/lemon_meringue_pie.jpg'),
            Meal(name="Carrot Cake", description="Spiced cake with cream cheese frosting", price=6.99, admin_id=1, category_id=5, image='https://example.com/images/carrot_cake.jpg'),
            Meal(name="Banana Split", description="Ice cream with bananas and toppings", price=4.99, admin_id=2, category_id=5, image='https://example.com/images/banana_split.jpg'),
            Meal(name="Mousse", description="Light and fluffy chocolate mousse", price=7.99, admin_id=3, category_id=5, image='https://example.com/images/mousse.jpg'),
            Meal(name="Eclair", description="Pastry with cream filling", price=5.99, admin_id=4, category_id=5, image='https://example.com/images/eclair.jpg'),
            Meal(name="Macarons", description="Colorful French macarons", price=8.99, admin_id=5, category_id=5, image='https://example.com/images/macarons.jpg'),
            Meal(name="Profiteroles", description="Pastry with ice cream filling", price=7.99, admin_id=1, category_id=5, image='https://example.com/images/profiteroles.jpg'),
            Meal(name="Bread Pudding", description="Pudding with bread and raisins", price=6.99, admin_id=2, category_id=5, image='https://example.com/images/bread_pudding.jpg'),
            Meal(name="Key Lime Pie", description="Pie with a lime filling", price=5.99, admin_id=3, category_id=5, image='https://example.com/images/key_lime_pie.jpg'),
            Meal(name="Pavlova", description="Meringue dessert with fruits", price=8.99, admin_id=4, category_id=5, image='https://example.com/images/pavlova.jpg'),
            Meal(name="Sorbet", description="Frozen dessert with fruit flavors", price=4.99, admin_id=5, category_id=5, image='https://example.com/images/sorbet.jpg')
        ]
